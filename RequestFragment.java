                                    ...
                                    if (type.equals("received"))
                                    {
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                                            {
                                                ...
                                                holder.userStatus.setText("möchte mit dir befreundet sein");
                                                ...
                                                holder.itemView.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View v)
                                                    {
                                                        ...
                                                        builder.setTitle(requestUserName + " Kontakt Anfrage");
                                                                                                                ...
                                                                                                                ChatRequestsRef.child(list_user_id).child(currentUserID)
                                                                                                                        ...
                                                                                                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                            ...
                                                                                                                            public void onComplete(@NonNull Task<Void> task)
                                                                                                                            {
                                                                                                                                if (task.isSuccessful())
                                                                                                                                {
                                                                                                                                    Toast.makeText(getContext(), "Kontakt erfolgreich hinzugefügt", Toast.LENGTH_SHORT).show();
                                                                                                                                }
                                                                                        ...
                                                                                        ChatRequestsRef.child(list_user_id).child(currentUserID)
                                                                                                ...
                                                                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                    ...
                                                                                                    public void onComplete(@NonNull Task<Void> task)
                                                                                                    {
                                                                                                        if (task.isSuccessful())
                                                                                                        {
                                                                                                            Toast.makeText(getContext(), "Anfrage abgelehnt", Toast.LENGTH_SHORT).show();
                                                                                                        }
